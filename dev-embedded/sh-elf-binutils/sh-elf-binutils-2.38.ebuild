...
src_configure() {
	...
	myconf+=(
		# --disable-silent-rules should get passed automatically w/ econf
		# which >=sys-devel/binutils-2.39 uses, so can drop it then
	...
	# Adapted from https://gitea.planet-casio.com/Lephenixnoir/sh-elf-binutils/src/branch/master/configure.sh
	myconf+=(
